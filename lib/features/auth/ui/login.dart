...
class _LoginScreenState extends State<LoginScreen> {
                      ...
                      BlocBuilder<LoginBloc , LoginState>(
                       builder: (context, state) {
                        ...
                        decoration: InputDecoration(
                          labelText: 'Email',
                          labelStyle: _getLabelStyle(context, state, isEmail: true),
                         ...
                         builder: (context, state) {
                           ...
                           return TextFormField(
                             obscureText: !isPasswordVisible,
                                        decoration: InputDecoration(
                                          labelText: 'Password',
                                          labelStyle: _getLabelStyle(context, state, isEmail: false),
  ...
  TextStyle? _getLabelStyle(BuildContext context, LoginState state, {required bool isEmail}) {
